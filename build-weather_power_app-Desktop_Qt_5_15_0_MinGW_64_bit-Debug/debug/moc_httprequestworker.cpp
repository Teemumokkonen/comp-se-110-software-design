...
#include <memory>
#include "../../weather_power_app/httprequestworker.h"
...
void HttpRequestWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HttpRequestWorker::on_execution_finished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject HttpRequestWorker::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_HttpRequestWorker.data,
    qt_meta_data_HttpRequestWorker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
