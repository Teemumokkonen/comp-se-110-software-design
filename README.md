...
We used Qt Creator on windows (NOT THE REMOTE DESKTOP VERSION). Used standard C++ and Qt libraries and modules (Qt Chart, Qt Core, Qt Widgets, Qt Network). No need to download any other libraries.
